  ...
  return (
    <section className="z-0 min-h-screen bg-slate-100">
      ...
      <main className="flex h-full flex-auto flex-shrink-0 flex-col">
        {/* navbar */}
        <div className="sticky inset-0 z-30 h-16 flex-shrink-0 border-b border-slate-900/10 bg-white">
          <Navbar />
        </div>
        {/* body */}
        <div className="pointer-events-none fixed inset-x-0 top-16 min-h-64 w-full bg-gradient-to-r from-emerald-600 via-blue-600 to-indigo-600"></div>
